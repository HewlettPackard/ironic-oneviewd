...
class OneViewConfClient:
    ...
    def _get_oneview_conf(self):
        ...
        cfg.IntOpt('max_retries',
                   default=20,
                   help='Max connection retries to check changes in OneView'),
        cfg.BoolOpt('allow_override_server_profile',
                    default=False,
                    help='Option to allow overriding existing applied'
                         ' Server Profile with the Server Profile Template'
                         ' of a node')
        ]
    ...
    def get_max_retries(self):
        return self._CONF.max_retries


    def get_allow_override_server_profile(self):
        return self._CONF.allow_override_server_profile
