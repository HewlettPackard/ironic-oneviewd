...
class Facade(object):
    ...
    def create_node_port(self, node_uuid, port_mac_address):
        return self.ironicclient.port.create(node_uuid=node_uuid, address=port_mac_address)
    ...
    def prepare_and_do_ov_requests(self, uri, body={}, request_type='GET', api_version='120'):
        return self.oneviewclient.prepare_and_do_request(uri, body, request_type, api_version)
    ...
    def clone_and_assign_server_profile(self, server_hardware_uri,
        ...
        return self.oneviewclient.server_profile.clone_and_assign(server_hardware_uri,
                                      server_profile_template_uri, node_uuid)
